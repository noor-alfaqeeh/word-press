...
function tanawul_bakery_scripts() {
	...
	wp_add_inline_style( 'tanawul-bakery-basic-style',$custom_css );
...
//footer Link
define('TANAWUL_BAKERY_CREDIT','https://www.themeseye.com/wordpress/free-bakery-wordpress-theme/','tanawul-bakery');
