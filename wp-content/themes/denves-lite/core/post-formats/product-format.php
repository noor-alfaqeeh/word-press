...
if (!function_exists('denves_lite_product_format_function')) {

	function denves_lite_product_format_function() {
		...
		if ( denves_lite_postmeta( '_sale_price' ) ) :	
											
			$html .= '<span class="onsale">'.esc_html__( 'Sale!', 'denves-lite').'</span>';
	...
	add_action( 'denves_lite_product_format', 'denves_lite_product_format_function' );
