...
if (!function_exists('denves_lite_image_format_function')) {

	function denves_lite_image_format_function() {
	...
	add_action( 'denves_lite_image_format', 'denves_lite_image_format_function' );
