...
/****************************
*
* Liquido v1.0.0 - A Fluida Child Theme
...
function liquido_setup() {
	...
	add_theme_support( 'custom-header', array(
		'default-image'	=> get_stylesheet_directory_uri() . '/images/headers/waves.jpg',
	));

	// Default custom headers packaged with the theme.
	register_default_headers( array(
		'waves' => array(
			'url' => '%s/images/headers/waves.jpg',
			'thumbnail_url' => '%s/images/headers/waves.jpg',
